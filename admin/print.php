...
echo "<center><h2>BUKTI PEMBAYARAN BOOKING <br> 
...
echo "<table width='100%'><br/>
		  ...
		  <tr><td>Jam</td>     	<td> : &nbsp;$r[judul]</td></tr>
		  <tr><td>Tanggal Booking</td>   <td> : &nbsp;$tanggal, $r[jam]</td></tr>
		  <tr><td>Harga Lapangan</td>   	<td> : &nbsp;Rp $harga / Tiket</td></tr>
		  <tr><td>Lapangan</td>   	<td> : &nbsp;No. $r[bangku]</td></tr>
	  </table><hr>
	  <center>Selamat Menikmati Futsal..<br>
	  		  Futsal</center>";		
