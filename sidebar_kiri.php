...
if ($_SESSION[leveluser]=='members'){
  ...
  echo "<div class='widget_kanan'><div class='subtitle'></b><center> Login Pemesanan Lapang Futsal</center></div></div>
   <center> <table width=92% style='background:#339900; padding:20px; border:1px solid #cecece;'>
	 ...
	 echo "<div class='widget_kanan'><div class='subtitle'></b><center> ALAMAT</center> </div></div>";
	 
		echo "<center><table width=92% style='background:#339900; padding:20px; margin-bottom:15px; border:1px solid #cecece;'>
		<td align=center>
				<p style='bottom:14px; color:#fff;'>Jl M. Dahuri RT 003/004<br/>
				No Telp. 087879059691<br/>
				Email achmadramdhani89@gmail.com</p>
			  </td></table></center>";
?>
